...
function filterStudentsByGrade(students, grade) {
  ...
  const arr = students.filter(person => person.grade === grade).forEach(element => console.log(element));
...
function warnAboutMaxArrayLength(arr, maxLength) {
  if (typeof arr === "object" && typeof maxLength === 'number') {
...
function compareArrays(arr1, arr2) {
  let cond = JSON.stringify(arr1.sort()) === JSON.stringify(arr2.sort())
  console.assert(cond, 'Масиви не однакові!')
